...
//#include "../NFC/lockNFC.h"
//#include "../NFC/lockZP.h"
...
unsigned long int authorizedCards[][2] = {{1139634415, String("Card 1")},
							 	 	 	  {3109905381, "Card 2"},
										  {3845351192, "Card 3"},
										  {3295930656,"TestCard"}};
...
//const int authorizedCardsSize = 10;
...
//    	Serial.println(authorizedCardsSize);
    	Serial.println(authorizedCards[iterator][0]);
        if (idcard == authorizedCards[iterator][0])
        {
//        	Serial.println("IfCheck");
