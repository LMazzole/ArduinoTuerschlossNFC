...
char secretCode[] = {button3, button7, button5, button8};

/** customize your authorized cards here */
const unsigned long int authorizedCards[] = {	1139634415,	// "Card 1"
						3109905381,	// "Card 2"
						3845351192,	// "Card 3"
						3295930656};	// "TestCard"

char* authorizedCardsName[] = { "Card 1",
				"Card 2",
				"Card 3",
				"TestCard"};
